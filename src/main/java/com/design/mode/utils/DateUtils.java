...
public abstract class DateUtils {
     ...
     * @return
     */
    public static Date conversionTimeZone(Date source, String gmt) {
        DateFormat formatter = new SimpleDateFormat(YYYY_MM_DD_HH_MM_SS);
        formatter.setTimeZone(TimeZone.getTimeZone(gmt));
        String newZealandTime = formatter.format(source);

        return DateUtils.parse(newZealandTime,YYYY_MM_DD_HH_MM_SS );
    }


    public static Date conversionTimeZone(Date source, Integer offset) {
        offset = offset * -1;
        ...
        Date date = conversionTimeZone(source, "GMT" + flog + offset);
        return date;
    }
    ...
    public static Date parse(String date, String pattern) {
        ...
        try {
            ...
            System.out.println(String.format("日期格式有误date=%s，pattern=%s", date, pattern));
            return null;
        }
    }
